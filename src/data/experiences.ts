...
export const experiences: Experience[] = [
  {
    ...
    highlights: [
      'Oversaw 5+ student commissions',
      'Drafted foundational organizational bylaws',
      'Facilitated institutional student hearings',
    ],
  ...
  },
  {
    ...
    highlights: [
      'Awarded The Best Innovation',
      'Tested with 30+ real target users',
      'Created 50+ high-fidelity screen flows',
    ],
    imagePosition: '50% 80%',
  },
  {
    ...
    image: '/TD1.jpeg',
    description:
      'Building innovative digital solutions through user-centered design and modern software engineering.',
    story:
      'Co-founded a digital innovation studio focusing on engineering scalable web applications, enterprise platforms, and bespoke digital experiences for startups and SMEs.',
    skills: [
      'Next.js',
      'TypeScript',
      'System Architecture',
    ...
    highlights: [
      'Co-founded agile engineering studio',
      'Delivered 3+ enterprise digital products',
      'Implemented robust CI/CD and design systems',
    ],
  ...
  },
  {
    ...
    highlights: [
      'Mentored 60+ computer science students',
      'Curated 10+ design critique workshops',
      'Reviewed 30+ term project submissions',
    ],
    imagePosition: '50% 50%',
  },
  {
    ...
    highlights: [
      ...
      'Implemented interactive milestone tracking',
      'Featured in inclusive education showcase',
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      'Trained students in modern Git workflows',
      'Graded and guided capstone web applications',
    ],
  },
];
